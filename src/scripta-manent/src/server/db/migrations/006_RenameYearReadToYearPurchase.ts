...
export class RenameyearReadToYearPurchase1780477298496 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "books" DROP CONSTRAINT "chk_books_year_purchase"`);
        ...
        await queryRunner.query(`ALTER TABLE "books" RENAME COLUMN "year_purchase" TO "year_purchase"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "books" ADD CONSTRAINT "chk_books_year_purchase" CHECK (((year_purchase IS NULL) OR ((year_purchase >= 1800) AND (year_purchase <= 2200))))`);
